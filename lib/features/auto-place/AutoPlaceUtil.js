 ...
 * @return {Point}
 */
export function getFreePosition(source, element, position, getNextPosition) {
 ...
 *
 * @param {Object} escapeDirection
 * @param {Object} [escapeDirection.x]
 * @param {Object} [escapeDirection.y]
 *
 * @returns {Function}
 */
export function simpleGetNextPosition(escapeDirection) {
  return function(element, position, connectedAtPosition) {
    var newPosition = {
      x: position.x,
      y: position.y
    };
    ...
    [ 'x', 'y' ].forEach(function(axis) {
      ...
      var axisDelta = escapeDirection[axis];
...
export function getConnectedDistance(source, hints) {
  ...
  var defaultDistance = hints.defaultDistance || DEFAULT_DISTANCE,
      ...
      maxDistance = hints.maxDistance || MAX_DISTANCE,
  ...
  var distances = sourcesDistances.concat(targetsDistances).reduce(function(accumulator, currentValue) {
    accumulator[ currentValue.id + currentValue.weight ] = currentValue;
